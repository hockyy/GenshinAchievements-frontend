export const Tips = [
  ...
  'Dari riset dan pengolahan citra (termasuk tidur 😴 7 jam), situs ini dibuat dalam waktu kurang dari 17 jam.',
  'Server <i>backend API</i> dari aplikasi ini tidak diberi perlindungan batas banyak permintaan.',
];
